...
export const domains = [
  { title: "AI & Automation", icon: Bot, text: "Artificial intelligence and automation systems that improve productivity, decision-making, and operational speed.", image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?auto=format&fit=crop&w=640&h=360&q=80", explorerImage: "https://images.unsplash.com/photo-1507146426996-ef05306b995a?auto=format&fit=crop&w=800&h=450&q=80" },
...
export const services = [
  ...
  { title: "Registration & Trademark", icon: Building2, text: "Company registration, LLP, private limited, GST, MSME, Udyam, trademark, IP, and documentation.", size: "lg:row-span-2", image: "https://images.unsplash.com/photo-1450133064473-71024230f91b?auto=format&fit=crop&w=640&h=360&q=80" },
  ...
  { title: "Customized CRM Management", icon: UsersRound, text: "Founder-friendly CRM setup, customer journeys, automation flows, and operational visibility.", size: "lg:col-span-2", image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=640&h=360&q=80" },
];
