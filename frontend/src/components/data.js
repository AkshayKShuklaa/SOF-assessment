...
export const domains = [
  { title: "AI & Automation", icon: Bot, text: "Artificial intelligence and automation systems that improve productivity, decision-making, and operational speed.", image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?auto=format&fit=crop&w=400&q=80" },
  { title: "Cyber Security", icon: ShieldCheck, text: "Digital protection for systems, networks, privacy, compliance, and safe online operations.", image: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&w=400&q=80" },
  { title: "Electric Vehicle (EV)", icon: Zap, text: "Sustainable mobility concepts across electric vehicles, connected transport, and clean automotive models.", image: "https://images.unsplash.com/photo-1563720223185-11003d516935?auto=format&fit=crop&w=400&q=80" },
  { title: "Renewable Energy", icon: SunMedium, text: "Clean energy models using sunlight, wind, water, and modern grid innovation.", image: "https://images.unsplash.com/photo-1466611653911-95081537e5b7?auto=format&fit=crop&w=400&q=80" },
  { title: "Healthcare Innovation", icon: HeartPulse, text: "Medical technology, care delivery, diagnostics, and health platforms built for better outcomes.", image: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&w=400&q=80" },
  { title: "Satellite Innovation", icon: Orbit, text: "Space technology for communication, navigation, earth observation, and scientific research.", image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=400&q=80" },
  { title: "Radio Telescope Arrays", icon: Earth, text: "High-resolution observation concepts using multiple antennas working as one powerful telescope.", image: "https://images.unsplash.com/photo-1444703686981-a3abbc4d4fe3?auto=format&fit=crop&w=400&q=80" },
  { title: "Waste Management", icon: Flame, text: "Responsible collection, recycling, processing, and disposal systems for healthier cities.", image: "https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?auto=format&fit=crop&w=400&q=80" },
  { title: "Engineering Innovations", icon: Cpu, text: "Creative technologies that improve efficiency, sustainability, safety, and quality of life.", image: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=400&q=80" },
  { title: "Green House Innovation", icon: Lightbulb, text: "Controlled agriculture systems for climate efficiency, plant growth, and sustainable production.", image: "https://images.unsplash.com/photo-1585320806297-9794b3e4eeae?auto=format&fit=crop&w=400&q=80" },
  { title: "E-Commerce Innovation", icon: Globe2, text: "Digital commerce experiences, customer engagement, and modern online business operations.", image: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=400&q=80" },
  { title: "Smart Solar Energy", icon: SunMedium, text: "Intelligent photovoltaic systems that maximize efficiency and support modern power grids.", image: "https://images.unsplash.com/photo-1509391366360-2e959784a276?auto=format&fit=crop&w=400&q=80" },
  { title: "Automotive Innovation", icon: Zap, text: "EVs, autonomous systems, smart connectivity, and sustainable transportation manufacturing.", image: "https://images.unsplash.com/photo-1511919884226-fd3cad34687c?auto=format&fit=crop&w=400&q=80" },
  { title: "Robotics Innovation", icon: BrainCircuit, text: "Autonomous machines that increase productivity, safety, and precision across industries.", image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=400&q=80" },
  { title: "Internet of Things", icon: Binary, text: "Connected devices for smarter homes, cities, industries, and real-time operational data.", image: "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=400&q=80" },
  { title: "3D Printing", icon: Building2, text: "Layer-by-layer prototyping and production for customized, complex manufacturing.", image: "https://images.unsplash.com/photo-1562408590-e32931084e23?auto=format&fit=crop&w=400&q=80" },
  { title: "Gene Tech", icon: HeartPulse, text: "Genetic technologies for medicine, agriculture, therapies, and advanced research models.", image: "https://images.unsplash.com/photo-1507668077129-56e32842fceb?auto=format&fit=crop&w=400&q=80" },
  { title: "Blockchain", icon: BadgeCheck, text: "Secure decentralized ledgers that support transparency, trust, and immutable transactions.", image: "https://images.unsplash.com/photo-1621761191319-c6fb62004040?auto=format&fit=crop&w=400&q=80" },
  { title: "Virtual Reality", icon: Sparkles, text: "Immersive digital environments for education, training, entertainment, and simulation.", image: "https://images.unsplash.com/photo-1593508512255-86ab42a8e620?auto=format&fit=crop&w=400&q=80" },
];
